...
export default function WidgetRenderer({
  ...
  return (
    <div
      ...
      className={
        isStickyNote
          ...
          : `widget-container ${shapeClass} ${isSelected ? 'selected' : ''} ${hasInitPromptHeaderVisible ? 'has-init-prompt-header' : ''} ${widget.settings?.hideTitle ? 'no-title' : ''}`
      }
    ...
    >
      ...
      {/* Resize Handles - only on hover when NOT selected, smaller dots */}
