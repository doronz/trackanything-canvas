      ...
      <div className="p-4 space-y-6">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6 space-y-3">
          ...
          <div className="flex space-x-3">
            ...
            <button
              onClick={handleSave}
              className="flex-1 px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-[#FF5A78] to-[#FFC850] border border-transparent rounded-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition-shadow"
            >
              Save Changes
            </button>
          </div>
